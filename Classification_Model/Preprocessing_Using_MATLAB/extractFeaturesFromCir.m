...
%fileName = 'RangingWithCIRData3';
%version = 5;
%pdp_downsampling_factor = 5;
%pdp_downsampled_out = 4;

%measfiles = {[fileName '_v' num2str(version)]};
...
for ii = 1:numel(measfiles)
    ...
    for jj = 1:nmeas
        ...
        cir1 = reshape(cir1(1:pdp_downsampling_factor*pdp_downsampled_out), [], pdp_downsampled_out);
    ...
    save([file_name '_features_' num2str(version) '_pdp_' num2str(pdp_downsampled_out)], 'features');
